...
Le projet combine le Shell Script (pour le filtrage et le nettoyage des données) et le Langage C (pour le stockage et les calculs complexes).

L'application permet de :

Analyser les flux : Calculer les volumes d'eau (capacité, consommation réelle) des stations.

Détecter les fuites : Identifier les pertes d'eau dans le réseau d'une usine spécifique.
